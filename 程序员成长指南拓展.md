...
![ioc-timeline](F:\Tom\OneDrive\ABP版本解析\程序员成长指南拓展Img\ioc-timeline.png)
...
![image-20220809124056362](C:\Users\160588\AppData\Roaming\Typora\typora-user-images\image-20220809124056362.png)
...
![ioc-step](F:\Tom\OneDrive\ABP版本解析\程序员成长指南拓展Img\ioc-step.png)



在面向对象设计中，类应该以松散耦合的方式设计。松散耦合意味着一个类中的更改不应该强迫其他类进行更改，因此整个应用程序可以变得可维护和可扩展。让我们通过使用如下图所示的典型 n 层架构来理解这一点:

![NLayerArchitecture](F:\Tom\OneDrive\ABP版本解析\程序员成长指南拓展Img\NLayerArchitecture.png)
...
以下模式(但不限于)实现 IOC 原则:
![ioc-patterns](F:\Tom\OneDrive\ABP版本解析\程序员成长指南拓展Img\ioc-patterns.png)
...
![DI](F:\Tom\OneDrive\ABP版本解析\程序员成长指南拓展Img\DI.png)
